app.controller('XeditableCtrl', ['$scope', '$filter', '$http', 'editableOptions', 'editableThemes', 
  function($scope, $filter, $http, editableOptions, editableThemes){
    ...
    // editable table
    $scope.users = [
      {id: 1, name: 'Rice Packets', status: 2, group: 4, groupName: '5KG'},
      {id: 2, name: 'Oil Bottles', status: 3, group: 3, groupName: '9KG'},
      {id: 3, name: 'Potatos Boxes', status: 2, group: 3, groupName: '10KG'}
    ];
