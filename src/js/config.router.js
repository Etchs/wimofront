      ...
      function ($stateProvider,   $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG) {
          ...
          $stateProvider
              ...
              .state('app.page.neworder', {
                  url: '/neworder',
                  templateUrl: 'tpl/page_neworder.html',
                  resolve: load(['ui.select','js/controllers/select.js', 'js/controllers/form.js', 'js/app/map/load-google-maps.js', 'js/app/map/ui-map.js', 'js/app/map/map.js'], function(){ return loadGoogleMaps(); })
              })
              .state('app.page.order', {
                  url: '/order',
              ...
              .state('app.page.createinvoice', {
                  url: '/createinvoice',
                  templateUrl: 'tpl/page_createinvoice.html'
              })
